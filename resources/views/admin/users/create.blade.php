...
@section('title', 'Tambah User Editor')

@section('content')
<div class="mb-8 flex items-center justify-between">
    <div>
        <h1 class="text-2xl font-bold text-slate-900 dark:text-white">Tambah User Editor</h1>
        <p class="text-sm text-slate-500 dark:text-slate-400 mt-1">Buat akun editor baru untuk pengelolaan konten website.</p>
    </div>
...
<div class="max-w-2xl">
    <div class="bg-white dark:bg-slate-800 rounded-2xl shadow-sm border border-slate-100 dark:border-slate-700 overflow-hidden">
        <div class="px-6 py-4 border-b border-slate-100 dark:border-slate-700 flex items-center gap-3">
            ...
            <div>
                <h3 class="text-xs font-bold text-slate-900 dark:text-white uppercase tracking-widest">Role: Editor</h3>
                <p class="text-[10px] text-slate-400">Dapat mengelola berita, artikel, dan galeri</p>
            </div>
        </div>
        <div class="p-6">
            @if($errors->any())
