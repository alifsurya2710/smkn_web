...
<div class="bg-white dark:bg-slate-800 overflow-hidden shadow sm:rounded-lg transition-colors duration-300">
    <div class="p-6 text-gray-900 dark:text-gray-100">
        <h1 class="text-2xl font-bold mb-4 text-gray-900 dark:text-white">Welcome to SMKN 1 Katapang Dashboard!</h1>
        <p class="text-gray-600 dark:text-gray-400">You are logged in as <strong class="text-gray-900 dark:text-white">{{ Auth::user()->name }}</strong> with role <strong class="text-blue-600 dark:text-blue-400">{{ Auth::user()->roles->first()->name ?? 'N/A' }}</strong>.</p>
        ...
        <div class="mt-8 grid grid-cols-1 gap-6 sm:grid-cols-2 lg:grid-cols-3">
            ...
            <div class="bg-blue-50 dark:bg-slate-700/50 p-6 rounded-xl border border-blue-100 dark:border-slate-700 transition-colors duration-300">
                <div class="flex items-center">
                    ...
                    <div class="ml-4">
                        <p class="text-sm font-medium text-gray-500 dark:text-gray-400">Quick Stats</p>
                        <p class="text-2xl font-semibold text-gray-900 dark:text-white">Overview</p>
                    </div>
                </div>
            </div>
        </div>
